...
export class LoggerService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.9", ngImport: i0, type: LoggerService, deps: [{ token: i1.Clipboard }], target: i0.ɵɵFactoryTarget.Injectable }); }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.9", ngImport: i0, type: LoggerService, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1.Clipboard }]; } });
