...
export class LoggerService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.0.0", ngImport: i0, type: LoggerService, deps: [{ token: i1.Clipboard }], target: i0.ɵɵFactoryTarget.Injectable }); }
